...
Public Class provincia
    ...
    Private Sub provincia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        TextB_Provincia.Text = ABMSocios.Text_Provincia.Text
        Try
            Call conectar()
            conexion.Open()
    ...
    Private Sub But_Modificar_Click(sender As System.Object, e As System.EventArgs) Handles But_Modificar.Click
        If TextB_Provincia.Text <> "" Then
            Try
                ...
                Comando.Connection = conexion
                Comando.CommandType = CommandType.Text
                Comando.CommandText = "select * from provincia where nom_provincia = '" & TextB_Provincia.Text.Trim & "';"
                Dim DReader As MySqlDataReader
                DReader = Comando.ExecuteReader
                If DReader.HasRows Then
                    ...
                    Close()
                Else
                    MsgBox("No se puede modidicar una provincia que no a sido cargado")
                    TextB_Provincia.Focus()
                End If
                DReader.Close()
                conexion.Close()
